...
CAMERA_DISTANCE_OVERRIDE = 2000.0       -- How far out should we allow the camera to go?  1134 is the default in Dota
...
XP_PER_LEVEL_TABLE = {}
for i=1,5 do
  XP_PER_LEVEL_TABLE[i] = (i-1) * 1000
end
local expIncrease = 1200
for i=6,MAX_LEVEL do
  XP_PER_LEVEL_TABLE[i] = XP_PER_LEVEL_TABLE[i-1] + expIncrease
  expIncrease = expIncrease + 200
end
