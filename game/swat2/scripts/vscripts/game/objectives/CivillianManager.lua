...
-- @param delay | [Optional] Time until we spawn APC. If not provided a default value will be set based on difficulty
function CivillianManager:spawnApc(delay)
    -- Set default value of delay if not provided
    delay = delay or (g_GameManager.isSurvival and 0 or 60)
    if SHOW_CIVILLIAN_MANAGER_LOGS then
